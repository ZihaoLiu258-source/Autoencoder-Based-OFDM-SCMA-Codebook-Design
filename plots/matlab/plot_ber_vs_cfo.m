...
% Input:  artifacts/main/sweeps/SCMA_SweepCFO_Simulation_Results.mat
% Output: artifacts/main/figures/BER_vs_cfo.{pdf,eps}
% =========================================================================
clear; clc; close all;

script_dir = fileparts(mfilename('fullpath'));
repo_root = fileparts(fileparts(script_dir));
data_file = fullfile(repo_root, 'artifacts', 'main', 'sweeps', 'SCMA_SweepCFO_Simulation_Results.mat');
...
try
    exportgraphics(gcf, fullfile(figure_dir, 'BER_vs_cfo.pdf'), 'ContentType', 'vector');
    exportgraphics(gcf, fullfile(figure_dir, 'BER_vs_cfo.eps'), 'ContentType', 'vector');
    disp('Saved: BER_vs_cfo.{pdf,eps}');
catch
    saveas(gcf, fullfile(figure_dir, 'BER_vs_cfo.png'));
