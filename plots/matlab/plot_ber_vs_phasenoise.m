...
% Input:  artifacts/main/sweeps/SCMA_CFO_Simulation_Results.mat
% Output: artifacts/main/figures/BER_vs_phasenoise.{pdf,eps}
% =========================================================================
clear; clc; close all;

script_dir = fileparts(mfilename('fullpath'));
repo_root = fileparts(fileparts(script_dir));
data_file = fullfile(repo_root, 'artifacts', 'main', 'sweeps', 'SCMA_CFO_Simulation_Results.mat');
...
try
    exportgraphics(gcf, fullfile(figure_dir, 'BER_vs_phasenoise.pdf'), 'ContentType', 'vector');
    exportgraphics(gcf, fullfile(figure_dir, 'BER_vs_phasenoise.eps'), 'ContentType', 'vector');
    disp('Saved: BER_vs_phasenoise.{pdf,eps}');
catch
    saveas(gcf, fullfile(figure_dir, 'BER_vs_phasenoise.png'));
