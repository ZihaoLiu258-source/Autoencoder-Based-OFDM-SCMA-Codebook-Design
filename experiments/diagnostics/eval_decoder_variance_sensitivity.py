...
OUTPUT_DIR = Path("artifacts/main/diagnostics")
OUTPUT_MAT = OUTPUT_DIR / "decoder_variance_sensitivity.mat"
OUTPUT_CSV = OUTPUT_DIR / "decoder_variance_sensitivity.csv"
OUTPUT_LOG = OUTPUT_DIR / "eval_decoder_variance_sensitivity.log"
...
def run():
    ...
    proposed_raw = sim.hardzero(
        sim.load_trained_cb1_kmv(
            "artifacts/main/checkpoints/cb1_kmv.pt", device=device
        ),
