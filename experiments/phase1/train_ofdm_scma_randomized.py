...
``artifacts/phase1/m1_randomized_training`` so the original fixed-point checkpoint is
never overwritten.
"""
...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "artifacts/phase1/m1_randomized_training"
CFO_RANGE = (0.0, 0.06)
