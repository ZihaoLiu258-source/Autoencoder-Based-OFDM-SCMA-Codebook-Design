...
from experiments.phase1.phase1_control_utils import (
    clustered_paired_difference,
    evaluate_at_point,
)
...
ARTIFACT_DIR = Path("artifacts/phase1/m3_no_med")
CHECKPOINTS = [Path("artifacts/main/checkpoints/cb1_kmv.pt"), ARTIFACT_DIR / "cb1_kmv.pt"]
