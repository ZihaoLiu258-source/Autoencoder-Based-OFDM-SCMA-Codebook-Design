...
from experiments.phase1.analyze_randomized_training_ablation import (
    load_normalized,
    summarize,
)
...
ARTIFACT_DIR = Path("artifacts/phase1/summary")
CHECKPOINTS = [
    Path("artifacts/main/checkpoints/cb1_kmv.pt"),
    Path("artifacts/phase1/m3_no_med/cb1_kmv.pt"),
    Path("artifacts/phase1/m4_seed_check/seed1/cb1_kmv.pt"),
    Path("artifacts/phase1/m4_seed_check/seed2/cb1_kmv.pt"),
]
