...
REQUIRED_PATHS = {
    ...
    Path("tools/validate_phase1_artifacts.py"),
    Path("experiments/phase1/train_ofdm_scma_randomized.py"),
    Path("experiments/diagnostics/analyze_codebook_energy.py"),
    Path("plots/matlab/plot_ber_vs_cfo.m"),
